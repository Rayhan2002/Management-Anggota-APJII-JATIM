            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    @if (auth()->user()->level_id == 1)
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#anggota" data-toggle="collapse" role="button"
                                aria-expanded="false" aria-controls="navbar-forms">
                                <i class="fas fa-user text-info"></i>
                                <span class="nav-link-text">Management Anggota</span>
                            </a>
                            <div class="collapse" id="anggota">
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('anggotas.create') }}">
                                            <span class="nav-link-text">Add Anggota</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="{{ route('list') }}">
                                            <span class="nav-link-text">List Anggota</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
